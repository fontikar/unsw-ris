...
::: fragment
![](../images/ecostats_hex.png){width="30%"}
![](../images/smatr_hex.png){width="30%"}
![](../images/mvabund_hex.png){width="30%"}
![](../images/litterfitter_hex.png){width="30%"}
:::  
:::
...
## Hi! My name is Fonti {.smaller} {.scrollable}
